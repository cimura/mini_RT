...
/*   Updated: 2025/04/05 23:32:00 by ttakino          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
	...
	const t_object *sphere, const t_ray *ray)
{
	...
	coef->a =
		calculate_inner_product(ray->orientation_vec, ray->orientation_vec);
	coef->b =
		2.0 * calculate_inner_product(start_to_sphere, ray->orientation_vec);
	coef->c =
		calculate_inner_product(start_to_sphere, start_to_sphere)
