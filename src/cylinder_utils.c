...
/*   Updated: 2025/04/05 23:05:41 by ttakino          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "renderer.h"

static double	a_coef(const t_vector *dir_vec, double co_dot_dir, double co_dot_co)
{
	double	dir_dot_dir;
...
static double	b_coef(double co_dot_dir, double dir_dot_stc, double co_dot_stc,
	double co_dot_co)
{
