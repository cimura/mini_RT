...
/*   Updated: 2025/04/04 00:18:51 by ttakino          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_ray	get_refraction_ray(t_catadioptric_vars catadioptric_vars,
...
static void	set_catadioptric_vars(t_catadioptric_vars *cv,
	t_world world, t_intersection intersection)
{
	double	rfr_2_1;
...
t_dcolor	calculate_catadioptric_radiance(t_world world,
	t_intersection intersection, t_ray ray, int recursion_level)
{
	t_dcolor			color;
	t_catadioptric_vars	catadioptric_vars;
	t_ray			rfl_ray;
