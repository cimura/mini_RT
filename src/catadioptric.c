...
/*   Updated: 2025/04/03 21:17:26 by ttakino          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static t_ray	get_reflection_ray(t_intersection intersection,
	t_vector inverce_ray_vec, double inverce_ray_dot_normal)
{
	t_ray	rfl_ray;
	...
	t_ray ray, int recursion_level)
{
	...
	rfl_ray =
		get_reflection_ray(intersection, inverce_ray_vec, inverce_ray_dot_normal);
	...
	if (intersection.object.material.use_refraction == false)
		return (color);
	refraction_index1 = world.global_refractive_index;
	refraction_index2 = intersection.object.material.refractive_index;
	if (intersection.hit_on_back == true)
	{
		refraction_index1 = intersection.object.material.refractive_index;
		refraction_index2 = world.global_refractive_index;
	}
	...
	color = dcolor_add(color, dcolor_coef_multi(dcolor_multi(ray_trace_recursive(world,
